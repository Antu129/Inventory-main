			...
			<form onsubmit="return alert('Product successfully added.');" action="../actions/product_add.php" method="POST">
				...
				<div class="header">
					...
					<div class="form-group">
						<input required type="text" class="form-control" name="productdesc"placeholder="Product Name">
					</div>
					...
					<div class="form-group">	
						<input required type="text" class="form-control" name="productunit" placeholder="Measuring Unit">
					</div>
					<div class="form-group">
						<input type="text" class="form-control" name="unitprice"placeholder="Per Unit Price">
					</div>
					<div class="form-group">
